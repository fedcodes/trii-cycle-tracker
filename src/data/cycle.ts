...
export const DISCOVERY: DiscoveryObjective[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { name: "Diferencial de spreads y comisiones para usuarios pro (US Stocks)", stage: "backlog", owner: "Juanita", designer: "Jael", priority: "med", figma: null, notes: "Carry-over de C2." },
    ],
  },
  {
    id: 3,
  ...
  {
    id: 4,
    name: "Obj. 4 — Mejorar experiencia CX",
    shortName: "Experiencia CX",
    description: "Reposicionado este ciclo de 'Activación al 50%' a 'CX': bajar tickets y subir NPS removiendo fricción del onboarding y de depósitos / pagos. Federico toma el objetivo como PO; James Alonso lidera diseño.",
    metric: "Tickets CX bajan · NPS sube",
    target: "Fin 2026",
    po: "Federico",
    ...
    tasks: [
      ...
      { name: "Activación post-onboarding", stage: "research", owner: "Federico", designer: "James Alonso", priority: "med", figma: null, notes: "Una vez el nuevo onboarding CO arranque a build, definir activación posterior." },
      { name: "Cambiar Pasarela de Pago Perú", stage: "research", owner: "Federico", designer: null, priority: "med", figma: null, notes: "Nuevo · evaluar alternativas a la pasarela actual en PE para destrabar activación." },
  ...
  },
  {
    ...
    designer: "Ange",
    tasks: [
      { name: "Rentabilidad total", stage: "research", owner: "Juanita", designer: "Jael", priority: "med", figma: null, notes: "Renombrado desde \"Rentabilidad de fondos de inversión\". Scope ampliado a rentabilidad total — reasignado a Juanita · Jael." },
